...
open(url) do |creatures_request|
  ...
  #       # object = {}
  #       # object['name'] =          creature['name'] if creature['name']
  #       # object['description'] =   creature['desc'] if creature['desc']
  #       # object['higher_level'] =  creature['higher_level'] if creature['higher_level']
  #       # object['range'] =         creature['range'] if creature['range']
  #       # object['components'] =    creature['components'] if creature['components']
  #       # object['material'] =      creature['material'] if creature['material']
  #       # object['ritual'] =        creature['ritual'] if creature['ritual']
  #       # object['duration'] =      creature['duration'] if creature['duration']
  #       # object['concentration'] = creature['concentration'] if creature['concentration']
  #       # object['casting_time'] =  creature['casting_time'] if creature['casting_time']
  #       # object['level_int'] =     creature['level_int'] if creature['level_int']
  #       # object['school'] =        creature['school'] if creature['school']
  #       # object['dnd_class'] =     creature['dnd_class'] if creature['dnd_class']
  #       # object['archetype'] =     creature['archetype'] if creature['archetype']
  #       # object['circles'] =       creature['circles'] if creature['circles']
